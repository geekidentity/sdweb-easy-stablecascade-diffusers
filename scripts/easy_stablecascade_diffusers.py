...
def predict(prompt, negative_prompt, width, height, guidance_scale, prior_steps, decoder_steps, seed, batch_size):
    device = "cuda"
    prior = StableCascadePriorPipeline.from_pretrained("/stable-diffusion-webui/models/StableCascade/stable-cascade-prior", 
    ...
    decoder = StableCascadeDecoderPipeline.from_pretrained("/stable-diffusion-webui/models/StableCascade/stable-cascade", 
            low_cpu_mem_usage=False, ignore_mismatched_sizes=True,
